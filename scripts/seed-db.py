        ...
        with conn.cursor() as cur:
            ...
            users = [
                ...
                (
                    "traveler",
                    "travel@example.com",
                    "Digital nomad sharing travel experiences",
                ),
                (
                    "bookworm",
                    "books@example.com",
            ...
            posts = [
                ...
                (
                    ...
                    "A curated list of the most amazing coffee experiences...",
                    2,
                    ["food", "coffee", "sf"],
                ),
                (
                    "Digital Nomad Guide to Thailand",
                    "Everything you need to know about working remotely from Thailand...",
                    3,
                    ["travel", "remote-work"],
                ),
                (
                    "Book Review: 1984 by George Orwell",
                    "A timeless classic that feels more relevant than ever...",
                    4,
                    ["books", "review"],
                ),
            ]
